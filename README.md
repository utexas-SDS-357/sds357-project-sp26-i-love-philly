...
1. **Comparison of Stop Patterns**
   ...
   Examine how traffic and pedestrian stop patterns differ between game days and non-game days across major league sports in Philadelphia. This will include analyzing stop frequency arrest rates and types of stops, as well as variation by sport and proximity to stadium locations.

2. **Predictive Modeling of Game Day Outcomes** 
   
   Determine whether game-related characteristics can predict traffic stops or arrest rates by analyzing the extent to which score differential, the opponent played, or game significance affect the nature of stops performed on a game day. For example, it is reasonable to predict that sports fans will be more animated when their team is playing their biggest rival- for the Eagles, that is the Dallas Cowboys. We hope to see how this may predict changes in traffic stop outcomes. 

3. **Statistical Significance of Event Effects**
